...
If you are having trouble in your local environment check this [Next-auth with NextJs 13 for local development.](https://faq-codewithantonio.vercel.app/cheatsheets/next-auth-local)

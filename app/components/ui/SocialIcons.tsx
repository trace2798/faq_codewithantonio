  ...
  return (
    <>
      <div className="flex ">
        ...
        <a
          href="https://www.youtube.com/@codewithantonio/videos"
          target="_blank"
          className="px-3 pt-[6px] transition-all hover:text-slate-900 dark:rotate-0 dark:scale-100 dark:text-slate-400 dark:hover:text-slate-100"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
